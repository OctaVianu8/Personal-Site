...
// ../.wrangler/tmp/bundle-fPOb5z/checked-fetch.js
...
var preflight = /* @__PURE__ */ __name(() => new Response(null, { status: 204, headers: CORS }), "preflight");

// api/photos/[id]/order.ts
var onRequestOptions = preflight;
async function onRequestPatch({ env, params, request }) {
  const id = params.id;
  const { display_order } = await request.json();
  await env.DB.prepare(`UPDATE photos SET display_order = ? WHERE id = ?`).bind(display_order, id).run();
  return Response.json({ ok: true }, { headers: CORS });
}
__name(onRequestPatch, "onRequestPatch");

// api/photos/upload.ts
var onRequestOptions2 = preflight;
...
// api/albums/[slug].ts
var onRequestOptions3 = preflight;
...
// api/photos/[id].ts
var onRequestOptions4 = preflight;
...
// api/photos/[[path]].ts
var onRequestOptions5 = preflight;
...
// api/albums.ts
var onRequestOptions6 = preflight;
...
// ../.wrangler/tmp/pages-FRpD4h/functionsRoutes-0.7010988636921929.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-fPOb5z/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-fPOb5z/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.1931835880111401.mjs.map
